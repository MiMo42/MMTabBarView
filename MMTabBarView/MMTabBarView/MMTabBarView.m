...
- (void)encodeWithCoder:(NSCoder *)aCoder 
{
	...
	if ([aCoder allowsKeyedCoding]) {
		...
		[aCoder encodeBool:_sizeButtonsToFit forKey:@"PSMsizeButtonsToFit"];
		...
		[aCoder encodeObject:_partnerView forKey:@"PSMpartnerView"];
...
- (id)initWithCoder:(NSCoder *)aDecoder 
{
	...
	if (self) {
		...
		if ([aDecoder allowsKeyedCoding]) {
			...
			_sizeButtonsToFit = [aDecoder decodeBoolForKey:@"PSMsizeButtonsToFit"];
			...
			_partnerView = [[aDecoder decodeObjectForKey:@"PSMpartnerView"] retain];
